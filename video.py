...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_video', default=None, type=str, dest='input_video', help='Input Video.')
    ...
    from segmentor.video_tester import VideoTester 
    model = VideoTester(configer) 
    model.test()
